...
select name, created_on from students where  created_on='2021-03-26 00:00:00'
 ...
 --10. Вывести пользователей где в имени есть слово Анна(Anna?)
...
select name from students where created_on='2021-07-12 00:00:00' and name LIKE '%8%'
 ...
 --17. Вывести пользователя у которых id равен 110 (112 - min)
...
select name from students where id>180 and id<190
 ...
 --25. Вывести пользователя у которых id между 180 и 190 (выводит включительно)
...
select count(user) from students
